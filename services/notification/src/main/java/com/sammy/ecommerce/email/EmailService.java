package com.sammy.ecommerce.email;

import com.sammy.ecommerce.kafka.order.Product;
...
public class EmailService {
    ...
    @Async
    public void sendPaymentEmail(String destinationEmail, String customerName, BigDecimal amount, String orderReference)
        ...
        messageHelper.setFrom("contact@sammy.com");
